...
public class FinalOrderActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        else if (chosenPay.equals("Credit card")){
    ...
    public void send_order_click(View view) {
        ...
        SharedPreferences myPref =
                getSharedPreferences("info", MODE_PRIVATE);
        String chosenPay = myPref.getString("chosen_payment","Cash");
        if (!chosenPay.equals("Cash")) {
